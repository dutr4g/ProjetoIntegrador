  ...
  <main class="flex justify-center items-center min-h-screen">
    <section class="login-container bg-gray-50 rounded-lg shadow-md p-8 w-96">
      ...
      <form action="<?= site_url('login') ?>" method="POST" class="space-y-4">
        ...
        <button type="submit" class="btn-primary text-black">Entrar</button>
      </form>
      <div class="create-account mt-4">
        <p class="text-gray-600 text-center">Não tem uma conta? <a href="<?= base_url('criar-conta') ?>" class="text-blue-500">Criar uma conta</a></p>
      </div>
    </section>
  </main>
